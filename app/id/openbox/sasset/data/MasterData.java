...
import id.openbox.sasset.models.*;
                    ...
                    case 0:
                      data.treg =
                          TREG.find
                              .query()
                              .where()
                              .eq("name", cell.getStringCellValue())
                              .findUnique();
                      break;
                    case 2:
                      data.name = formatter.formatCellValue(cell);
                    ...
                    case 0:
                      data.electricityPAM =
                          ElectricityPAM.find
                              .query()
                              .where()
                              .eq("id", (long) cell.getNumericCellValue())
                              .findUnique();
                      break;
                    case 1:
              ...
              while (cellIterator.hasNext()) {
                ...
                if (checkIfCellNull(cell)) {
                  switch (cell.getColumnIndex()) {
                    ...
                    case 1:
                      data.electricity =
                          ElectricityPAM.find.byId((long) cell.getNumericCellValue());
                      break;
                    case 2:
                    ...
                    case 1:
                      data.office =
                          Office.find
                              .query()
                              .where()
                              .eq("electricity_id", Long.valueOf(formatter.formatCellValue(cell)))
                              .findUnique();
                      break;
                    case 2:
                    ...
                    case 1:
                      data.assetType =
                          AssetType.find
                              .query()
                              .where()
                              .eq("name", formatter.formatCellValue(cell))
                              .findUnique();
                      break;
                    case 2:
